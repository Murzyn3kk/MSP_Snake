...
void Send_String(char characters[], int wybor); void CreateCharacters(); 
...
void Send_String(char characters[], int wybor){ 
...
void Game(void){ 
  ...
  if(counter==0){ 
    ...
    counterFrame = counterFrame % 20;     
    if(counterFrame == przedzial) {         //szansa na postawienie przeciwnika 
        przedzial = DifficultyStep + (rand()%DifficultyStep2); 
